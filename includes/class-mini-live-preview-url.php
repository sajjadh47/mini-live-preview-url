<?php
/**
 * This file contains the definition of the Mini_Live_Preview_Url class, which
...
class Mini_Live_Preview_Url {
	 ...
	 * @since     2.0.0
	 * @access    protected
	 * @var       Mini_Live_Preview_Url_Loader $loader Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct() {
		$this->version     = defined( 'MINI_LIVE_PREVIEW_URL_PLUGIN_VERSION' ) ? MINI_LIVE_PREVIEW_URL_PLUGIN_VERSION : '1.0.0';
		$this->plugin_name = 'mini-live-preview-url';
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once MINI_LIVE_PREVIEW_URL_PLUGIN_PATH . 'includes/class-mini-live-preview-url-loader.php';
		 ...
		 */
		require_once MINI_LIVE_PREVIEW_URL_PLUGIN_PATH . 'admin/class-mini-live-preview-url-admin.php';

		/**
		 * The class responsible for defining all actions that occur in the public-facing
		 * side of the site.
		 */
		require_once MINI_LIVE_PREVIEW_URL_PLUGIN_PATH . 'public/class-mini-live-preview-url-public.php';

		$this->loader = new Mini_Live_Preview_Url_Loader();
	}

	/**
	 * Define the locale for this plugin for internationalization.
	 *
	 * Uses the Mini_Live_Preview_Url_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since     2.0.0
	 * @access    private
	...
	private function set_locale() {
		$plugin_i18n = new Mini_Live_Preview_Url_i18n();
	...
	private function define_admin_hooks() {
		$plugin_admin = new Mini_Live_Preview_Url_Admin( $this->get_plugin_name(), $this->get_version() );

		$this->loader->add_action( 'plugin_action_links_' . MINI_LIVE_PREVIEW_URL_PLUGIN_BASENAME, $plugin_admin, 'add_plugin_action_links' );
	...
	private function define_public_hooks() {
		$plugin_public = new Mini_Live_Preview_Url_Public( $this->get_plugin_name(), $this->get_version() );
	 ...
	 * @since     2.0.0
	 * @access    public
	 * @return    Mini_Live_Preview_Url_Loader Orchestrates the hooks of the plugin.
	 */
